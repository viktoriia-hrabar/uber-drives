...
### Аналіз датасету за визначеними темами
Процес аналізу та висновки до кожного питання наведені [в аркуші "Analysis"](https://docs.google.com/spreadsheets/d/1kpIIrxtR7aE1Um2RVIqr--so8HPjbukPjovkHnxZhsc/edit?gid=505879183#gid=505879183). 
